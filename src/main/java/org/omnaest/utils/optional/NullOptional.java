...
public class NullOptional<T>
{
     ...
     * @return
     */
    public NullOptional<T> orElseGetAndMapNullable(Supplier<T> supplier)
    {
     ...
     * 
     * @see #orElseGetAndMapNullable(Supplier)
     * @see #orElseGet(Supplier)
     * @param supplier
     * @return
     */
    public NullOptional<T> orElseGetAndFlatMap(Supplier<NullOptional<T>> supplier)
    {
